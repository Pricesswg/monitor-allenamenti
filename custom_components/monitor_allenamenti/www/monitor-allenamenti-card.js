...
`;function ft(t,e=16,i=1.6){const s=e,r=i;switch(t){case"dashboard":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="9" rx="1.5"/><rect x="14" y="3" width="7" height="5" rx="1.5"/><rect x="14" y="12" width="7" height="9" rx="1.5"/><rect x="3" y="16" width="7" height="5" rx="1.5"/></svg>`;case"dumbbell":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 6.5h11M6 12h12"/><rect x="2" y="8" width="4" height="8" rx="1"/><rect x="18" y="8" width="4" height="8" rx="1"/><rect x="5" y="6" width="2" height="12" rx="0.5"/><rect x="17" y="6" width="2" height="12" rx="0.5"/></svg>`;case"scale":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="3"/><circle cx="12" cy="12" r="4"/><path d="M12 8v4l2.5 1.5"/></svg>`;case"calendar":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/></svg>`;case"user":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 4-6 8-6s8 2 8 6"/></svg>`;case"target":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1"/></svg>`;case"chart":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M3 20h18"/><path d="M5 20V10l4-3 4 5 4-7 4 4v11"/></svg>`;case"sliders":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M4 21v-7M4 10V3M12 21v-9M12 8V3M20 21v-5M20 12V3M1 14h6M9 8h6M17 16h6"/></svg>`;case"settings":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.9 2.9l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 1 1-4 0v-.1a1.7 1.7 0 0 0-1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.9-2.9l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 1 1 0-4h.1a1.7 1.7 0 0 0 1.5-1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.9-2.9l.1.1a1.7 1.7 0 0 0 1.8.3H9a1.7 1.7 0 0 0 1-1.5V3a2 2 0 1 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.9 2.9l-.1.1a1.7 1.7 0 0 0-.3 1.8V9a1.7 1.7 0 0 0 1.5 1H21a2 2 0 1 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1z"/></svg>`;case"sword":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 17.5 3 6V3h3l11.5 11.5"/><path d="M13 19l6-6M16 16l4 4M9 5l1-1"/></svg>`;case"flame":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2c1 4 5 6 5 11a5 5 0 0 1-10 0c0-5 4-7 5-11z"/><path d="M12 18a2 2 0 0 1-2-2c0-2 2-3 2-5 0 2 2 3 2 5a2 2 0 0 1-2 2z"/></svg>`;case"trophy":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9V4h12v5a6 6 0 0 1-12 0z"/><path d="M6 6H3v3a3 3 0 0 0 3 3M18 6h3v3a3 3 0 0 1-3 3M9 19h6M12 15v4M8 21h8"/></svg>`;case"heart":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21C12 21 3 14 3 8.5a4.5 4.5 0 0 1 9-1 4.5 4.5 0 0 1 9 1C21 14 12 21 12 21z"/></svg>`;case"bolt":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M13 3 4 14h7l-1 7 9-11h-7z"/></svg>`;case"shield":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3 4 7v5c0 5 3.5 8 8 10 4.5-2 8-5 8-10V7z"/></svg>`;case"medal":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="15" r="5"/><path d="M8.2 13 6 3h3l3 4 3-4h3l-2.2 10"/></svg>`;case"run":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="14" cy="4" r="2"/><path d="M6 20l3-7 2 2 4-4 2 6"/><path d="M9 13l-3-3 5-2"/></svg>`;case"check":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="m5 13 4 4L19 7"/></svg>`;case"close":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M6 6l12 12M18 6 6 18"/></svg>`;case"menu":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h16"/></svg>`;case"chevron-right":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="m9 6 6 6-6 6"/></svg>`;case"chevron-left":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="m15 6-6 6 6 6"/></svg>`;case"info":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8h.01M11 12h1v5h1"/></svg>`;case"clock":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>`;case"plus":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg>`;case"play":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4v16l14-8z" fill="currentColor" stroke="none"/></svg>`;case"pause":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="5" width="4" height="14" fill="currentColor" stroke="none"/><rect x="14" y="5" width="4" height="14" fill="currentColor" stroke="none"/></svg>`;case"weight":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2"/><path d="M5 21h14l-2-14H7z"/></svg>`;case"droplet":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c3 4 6 7 6 11a6 6 0 0 1-12 0c0-4 3-7 6-11z"/></svg>`;case"trending-up":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M23 6l-9.5 9.5-5-5L1 18"/><path d="M17 6h6v6"/></svg>`;case"trending-down":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M23 18l-9.5-9.5-5 5L1 6"/><path d="M17 18h6v-6"/></svg>`;case"upload":return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${r}" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>`;default:return W`<svg width="${s}" height="${s}" viewBox="0 0 24 24"></svg>`}}function _t(t,e){const i=`sensor.monitor_allenamenti_${e}`;return t.states[i]?.state??""}function bt(t,e=0){const i="string"==typeof t?parseFloat(t):t;return isNaN(i)?"—":i.toLocaleString("it-IT",{minimumFractionDigits:e,maximumFractionDigits:e})}function $t(t,e=""){return`${t>0?"+":""}${bt(t,1)}${e?" "+e:""}`}function kt(t,e,i){if(t.length<2)return"";const s=Math.min(...t),r=Math.max(...t)-s||1,a=e/(t.length-1);return t.map((t,e)=>{const o=i-(t-s)/r*i;return`${0===e?"M":"L"}${(e*a).toFixed(1)},${o.toFixed(1)}`}).join(" ")}function yt(t,e,i){const s=Number.isFinite(t)?t:0,r=Math.min(1,Math.max(0,s)),a=2*Math.PI*e;return W`
  ...
  `}let wt=class extends dt{render(){const t=this.card.hass,e=this.card.monitorState,i=t.states["sensor.withings_peso"]?.state??"—",s=e?.points_total??0,r=e?.streak??0,a=e?.workouts??[],o=new Date,n=`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`,l=a.filter(t=>t.date?.startsWith(n)).length,d=[...a].sort((t,e)=>e.date.localeCompare(t.date)).slice(0,5),c=(e?.weight_history??[]).map(t=>t.weight),p=c.length>=2?c[c.length-1]-c[Math.max(0,c.length-8)]:0,h=c.length>=2?kt(c.slice(-14),160,36):"";return V`
      <div class="col" style="gap:22px">
        ...
        <div class="grid-4">
          <div class="kpi">
            ...
            <div class="kpi__delta" style="color:${p<=0?"var(--ok)":"var(--warn)"}">${c.length>=2?$t(p,"in 7g"):"—"}</div>
          </div>
          <div class="kpi">
          ...
          <div>
            ...
            <div class="kpi" style="display:flex;align-items:center;gap:20px;max-width:420px">
              <div style="flex:1">
                ...
                <div class="kpi__value">${i}<span class="text-mute" style="font-size:14px;margin-left:4px">kg</span></div>
                <div class="kpi__delta" style="color:${p<=0?"var(--ok)":"var(--warn)"}">${$t(p,"in 7g")}</div>
              </div>
          ...
          <div class="card" style="padding:16px">
            ...
            <div style="display:flex;align-items:center;gap:16px">
              <svg width="80" height="80" viewBox="0 0 100 100">
                ${yt(e.active_energy/(e.active_energy_goal||1),44,"var(--danger)")}
                ${yt(e.exercise_min/(e.exercise_goal||1),35,"var(--ok)")}
                ${yt(e.stand_hours/(e.stand_goal||1),26,"var(--accent)")}
              </svg>
          ...
          <div class="card" style="padding:16px">
            ...
            ${i.awake_min>0?V`
              <div class="text-mute text-xs" style="margin-bottom:8px">
                + ${i.awake_min}m svegli (totale ${Math.floor((i.total_min+i.awake_min)/60)}h ${(i.total_min+i.awake_min)%60}m in letto)
              </div>
            `:""}
            <div style="display:flex;gap:4px;height:8px;border-radius:4px;overflow:hidden;margin-bottom:10px">
              ${i.deep_min>0?V`<div style="flex:${i.deep_min};background:var(--accent)" title="Deep ${i.deep_min}m"></div>`:""}
              ${i.core_min>0?V`<div style="flex:${i.core_min};background:var(--ok)" title="Core ${i.core_min}m"></div>`:""}
              ${i.rem_min>0?V`<div style="flex:${i.rem_min};background:var(--warn)" title="REM ${i.rem_min}m"></div>`:""}
            </div>
            <div style="display:flex;gap:10px;flex-wrap:wrap">
              ${i.deep_min>0?V`<span class="text-xs"><span style="color:var(--accent)">●</span> Deep ${i.deep_min}m</span>`:""}
              ${i.core_min>0?V`<span class="text-xs"><span style="color:var(--ok)">●</span> Core ${i.core_min}m</span>`:""}
              ${i.rem_min>0?V`<span class="text-xs"><span style="color:var(--warn)">●</span> REM ${i.rem_min}m</span>`:""}
            </div>
          </div>
        `:""}
    ...
    `}};Mt.styles=xt,t([gt({attribute:!1,hasChanged:()=>!0})],Mt.prototype,"card",void 0),t([ut()],Mt.prototype,"_filter",void 0),Mt=t([pt("monitor-workouts")],Mt);const Ct=["7G","30G","3M","6M","1A"];function At(t){switch(t){case"7G":return 7;case"30G":return 30;case"3M":return 90;case"6M":return 180;case"1A":return 365}}function St(t,e){const i=t.states[e];return i&&"unknown"!==i.state&&"unavailable"!==i.state?i.state:null}let Et=class extends dt{constructor(){super(...arguments),this._range="30G"}render(){const t=this.card.hass,e=parseFloat(St(t,"sensor.withings_peso")||"0"),i=parseFloat(St(t,"sensor.withings_altezza")||"0"),s=parseFloat(St(t,"sensor.withings_obiettivo_di_peso")||"0"),r=parseFloat(St(t,"sensor.withings_passi_oggi")||"0"),a=parseFloat(St(t,"sensor.withings_calorie_attive_bruciate_oggi")||"0"),o=parseFloat(St(t,"sensor.withings_calorie_totali_bruciate_oggi")||"0"),n=parseFloat(St(t,"sensor.withings_distanza_percorsa_oggi")||"0"),l=parseFloat(St(t,"sensor.withings_attivita_intensa_oggi")||"0"),d=parseFloat(St(t,"sensor.withings_attivita_moderata_oggi")||"0"),c=parseFloat(St(t,"sensor.withings_attivita_leggera_oggi")||"0"),p=parseFloat(St(t,"sensor.withings_variazione_dell_elevazione_oggi")||"0"),h=i>0?e/(i*i):0,v=e-s,g=n/1e3,u=this.card.monitorState?.weight_history??[],m=At(this._range),x=new Date;x.setDate(x.getDate()-m);const f=x.toISOString().slice(0,10),_=u.filter(t=>t.date>=f),b=_.map(t=>t.weight),$=u.length>0?u[0].date:"";let k=0;if($){const t=new Date($),e=new Date;k=Math.max(1,Math.round((e.getTime()-t.getTime())/864e5)+1)}const y=140,w=b.length>=2?kt(b,460,y):"",z=_.length>=2?`${_[0].date} → ${_[_.length-1].date}`:"";return V`
      <div class="col" style="gap:22px">

        <div>
          <h1 class="page-title">Composizione</h1>
          <p class="page-sub">${bt(e,1)} kg · obiettivo ${bt(s,0)} kg (${$t(v,"kg")})</p>
        </div>

        <div class="segmented">
          ${Ct.map(t=>{const e=k>=At(t)||"7G"===t||0===k;return V`
              <button data-active="${this._range===t}"
                style="${e?"":"opacity:0.45"}"
                title="${e?"":`Servono almeno ${At(t)} giorni di storico (ne hai ${k})`}"
                @click=${()=>{this._range=t}}>
                ${t}
              </button>
            `})}
          ...
          <div class="card__header">
            ...
            ${b.length>=2?V`
              <span class="chip" style="margin-left:auto">
                ${$t(b[b.length-1]-b[0],"kg")}
              </span>
            `:""}
          </div>
          ${w?V`
            <svg class="sparkline" viewBox="0 0 ${460} ${y}" width="100%" height="200"
              ...
              <path d="${w} L${460},${y} L0,${y} Z" fill="url(#wg)"/>
              <polyline points="${w.replace(/[ML]/g,"")}" stroke="var(--accent)"/>
            </svg>
            <div class="text-mute text-xs" style="margin-top:8px;display:flex;justify-content:space-between;gap:8px;flex-wrap:wrap">
              <span>${_.length} misurazioni · ${z}</span>
              ${k<m?V`
                <span>Storico totale: ${k} giorni (richiesti ${m})</span>
              `:""}
            </div>
          `:V`
            <div style="height:200px;display:grid;place-items:center;color:var(--text-muted);text-align:center;padding:0 16px">
              ${0===u.length?V`Nessuno storico peso ancora.<br/><span class="text-xs">Lo storico cresce di una misurazione al giorno dalla bilancia Withings.</span>`:V`Nessun dato nel periodo selezionato.<br/><span class="text-xs">Hai ${k} giorni di storico totali.</span>`}
            </div>
          `}
        </div>
        ...
        <div class="grid-4" style="grid-template-columns:repeat(4, 1fr)">
          ...
          <div class="kpi">
            ...
            <div class="kpi__delta" style="color:${v>0?"var(--warn)":"var(--ok)"}">${$t(v,"kg")}</div>
          </div>
          <div class="kpi">
            <div class="kpi__label" style="display:flex;align-items:center;gap:5px">
              ${ft("chart",12)} BMI
    ...
    `}_renderCardioHealth(){const t=this.card.monitorState,e=t?.resting_hr??[],i=t?.vo2max??[],s=t?.hrv_daily??[];if(0===e.length&&0===i.length&&0===s.length)return"";const r=200,a=40,o=e.slice(-30).map(t=>t.bpm),n=o.length>=2?kt(o,r,a):"",l=e.length>0?e[e.length-1].bpm:0,d=i.map(t=>t.value),c=d.length>=2?kt(d,r,a):"",p=i.length>0?i[i.length-1].value:0,h=s.slice(-30).map(t=>t.value_ms),v=h.length>=2?kt(h,r,a):"",g=s.length>0?s[s.length-1].value_ms:0;return V`
      <div>
    ...
    `}};Et.styles=xt,t([gt({attribute:!1,hasChanged:()=>!0})],Et.prototype,"card",void 0),t([ut()],Et.prototype,"_range",void 0),Et=t([pt("monitor-body")],Et);const Pt=["var(--bg-sunken)","color-mix(in srgb, var(--accent) 25%, var(--bg-sunken))","color-mix(in srgb, var(--accent) 50%, var(--bg-sunken))","color-mix(in srgb, var(--accent) 75%, var(--bg-sunken))","var(--accent)"];let Dt=class extends dt{constructor(){super(...arguments),this._viewYear=(new Date).getFullYear(),this._viewMonth=(new Date).getMonth()}_nav(t){let e=this._viewMonth+t,i=this._viewYear;for(;e<0;)e+=12,i-=1;for(;e>11;)e-=12,i+=1;this._viewMonth=e,this._viewYear=i}_goToday(){const t=new Date;this._viewYear=t.getFullYear(),this._viewMonth=t.getMonth()}render(){const t=this.card.monitorState,e=t?.workouts??[],i=t?.streak??0,s=t?.streak_best??0,r=new Date,a=new Date(this._viewYear,this._viewMonth,1),o=this._viewYear===r.getFullYear()&&this._viewMonth===r.getMonth(),n=`${this._viewYear}-${String(this._viewMonth+1).padStart(2,"0")}`,l=e.filter(t=>t.date?.startsWith(n)),d=l.length,c=l.reduce((t,e)=>t+(e.volume_kg||0),0),p=l.reduce((t,e)=>t+(e.distance_km||0),0),h=new Date(this._viewYear,this._viewMonth+1,0).getDate(),v=new Set(l.map(t=>{try{return new Date(t.date).getDate()}catch{return 0}})),g=o?r.getDate():h,u=Math.max(0,g-v.size),m=new Map;for(const t of l)try{const e=new Date(t.date).getDate();m.set(e,(m.get(e)||0)+1)}catch{}const x=a.toLocaleDateString("it-IT",{month:"long",year:"numeric"}),f=function(t,e,i){const s=new Date(t,e,1),r=new Date(t,e+1,0).getDate(),a=(s.getDay()+6)%7,o=new Date,n=o.getDate(),l=o.getMonth()===e&&o.getFullYear()===t,d=t>o.getFullYear()||t===o.getFullYear()&&e>o.getMonth(),c=[];let p=[];for(let t=0;t<a;t++)p.push({day:0,intensity:-1});for(let t=1;t<=r;t++){if(d||l&&t>n)p.push({day:t,intensity:-1});else{const e=i.get(t)||0,s=0===e?0:1===e?1:2===e?2:3===e?3:4;p.push({day:t,intensity:s})}7===p.length&&(c.push(p),p=[])}if(p.length>0){for(;p.length<7;)p.push({day:0,intensity:-1});c.push(p)}return c}(this._viewYear,this._viewMonth,m);return V`
      <div class="col" style="gap:22px">
      ...
      <text x="50" y="62" text-anchor="middle" fill="var(--text-muted)" font-size="10"
        font-weight="500">giorni</text>
            ...
            <div class="grid-2" style="flex:1;min-width:200px;gap:14px">
              <div>
                ...
                <div class="mono fw-700" style="font-size:20px">${d}</div>
              </div>
              <div>
                <div class="text-mute text-xs" style="margin-bottom:2px">Riposi</div>
                <div class="mono fw-700" style="font-size:20px">${Math.max(0,u)}</div>
              </div>
              <div>
                <div class="text-mute text-xs" style="margin-bottom:2px">Volume</div>
                <div class="mono fw-700" style="font-size:20px">${bt(c)} kg</div>
              </div>
              <div>
                <div class="text-mute text-xs" style="margin-bottom:2px">Distanza</div>
                <div class="mono fw-700" style="font-size:20px">${bt(p,1)} km</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card__header" style="align-items:center;gap:8px">
            <h3 class="card__title" style="text-transform:capitalize;flex:1">${x}</h3>
            <button class="btn btn--ghost btn--icon" title="Mese precedente"
              @click=${()=>this._nav(-1)}
              style="padding:6px 10px">${ft("chevron-left",14)}</button>
            ${o?"":V`
            ...
            <button class="btn btn--ghost btn--icon" title="Mese successivo"
              @click=${()=>this._nav(1)}
              style="padding:6px 10px">${ft("chevron-right",14)}</button>
          </div>
          <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:4px">
            ...
            `)}
            ${f.flatMap(t=>t.map(t=>{if(0===t.day)return V`<div></div>`;const e=t.intensity>=0?Pt[t.intensity]:"var(--bg-soft)",i=t.day===r.getDate();return V`
    ...
    `}};Dt.styles=xt,t([gt({attribute:!1,hasChanged:()=>!0})],Dt.prototype,"card",void 0),t([ut()],Dt.prototype,"_viewYear",void 0),t([ut()],Dt.prototype,"_viewMonth",void 0),Dt=t([pt("monitor-calendar")],Dt);const Ot={pesi:"Pesi",corsa:"Corsa",cammino:"Cammino",hiit:"HIIT",nuoto:"Nuoto"},jt={pesi:"var(--accent)",corsa:"var(--ok)",cammino:"var(--warn)",hiit:"var(--danger)",nuoto:"var(--xp)"};let Tt=class extends dt{render(){const t=this.card.monitorState,e=t?.workouts??[],i=t?.weight_history??[],s=function(t){const e=[];for(const[i,s]of Object.entries(t)){const t=i.split("_"),r=t[0],a=t.slice(1).join("_");let o=Ot[r]||r,n="";switch(a){case"duration_min":o+=" durata",n=" min";break;case"calories":o+=" calorie",n=" kcal";break;case"distance_km":o+=" distanza",n=" km";break;case"volume_kg":o+=" volume",n=" kg";break;default:o+=` ${a}`}e.push({label:o,iconName:"corsa"===r?"run":"cammino"===r?"heart":"hiit"===r?"flame":"dumbbell",value:`${bt(s,"distance_km"===a?1:0)}${n}`,key:i})}return e}(t?.personal_records??{});return V`
    ...
    `}_renderCorrelation(t,e){const i=t.some(t=>t.volume_kg&&t.volume_kg>0),s=i?"volume_kg":"calories",r=i?"Volume (kg)":"Calorie (kcal)",a=i?"Peso corporeo vs Volume allenamento":"Peso corporeo vs Calorie bruciate",o=t.filter(t=>{const e=t[s];return e&&e>0}).slice(-30);if(o.length<3||e.length<3)return V`
        <div class="card">
          <div class="card__header">
      ...
      `;const n=30,l=140,d=new Map;for(const t of e)d.set(t.date,t.weight);const c=t=>{if(d.has(t))return d.get(t);const e=new Date(t);for(let t=1;t<=3;t++)for(const i of[-1,1]){const s=new Date(e);s.setDate(s.getDate()+i*t);const r=s.toISOString().slice(0,10);if(d.has(r))return d.get(r)}return null},p=[];for(const t of o){const e=c((t.date||"").slice(0,10)),i=t[s];null!==e&&i>0&&p.push([e,i])}if(p.length<3)return V`
        <div class="card">
          <div class="card__header"><h3 class="card__title">Correlazione</h3></div>
          <div style="padding:20px;text-align:center;color:var(--text-muted)">
            Solo ${p.length} punti con sia peso che allenamento nello stesso periodo.<br/>
            <span class="text-xs">Continua a usare la bilancia ogni giorno per popolare lo storico.</span>
          </div>
        </div>
      `;const h=p.map(t=>t[0]),v=p.map(t=>t[1]),g=Math.min(...h),u=Math.max(...h),m=Math.min(...v),x=Math.max(...v),f=u-g||1,_=x-m||1,b=t=>n+(t-g)/f*220,$=t=>170-(t-m)/_*l,k=p.length,y=h.reduce((t,e)=>t+e,0)/k,w=v.reduce((t,e)=>t+e,0)/k;let z=0,M=0,C=0;for(const[t,e]of p)z+=(t-y)*(e-w),M+=(t-y)**2,C+=(e-w)**2;const A=M>0&&C>0?z/Math.sqrt(M*C):0,S=Math.abs(A)>.6?"FORTE":Math.abs(A)>.3?"MODERATA":"DEBOLE",E=M>0?z/M:0,P=w-E*y,D=b(g),O=$(E*g+P),j=b(u),T=$(E*u+P);return V`
      <div class="card">
        <div class="card__header">
          <div style="flex:1">
            <h3 class="card__title">Correlazione</h3>
            <div class="card__sub">${a}</div>
          </div>
          <span class="chip chip--ok">${S}</span>
        </div>
        <div class="sp-between" style="margin-bottom:10px">
          <span class="text-sm text-soft">Coefficiente r (${p.length} punti)</span>
          <span class="mono fw-700" style="font-size:22px;color:${A<0?"var(--ok)":"var(--warn)"}">${A.toFixed(2)}</span>
        </div>
        <svg viewBox="0 0 ${280} ${200}" width="100%" style="display:block;max-height:200px">
          <line x1="${n}" y1="${n}" x2="${n}" y2="${170}" stroke="var(--border)" stroke-width="1"/>
          <line x1="${n}" y1="${170}" x2="${250}" y2="${170}" stroke="var(--border)" stroke-width="1"/>
          <text x="${140}" y="${196}" text-anchor="middle" fill="var(--text-muted)" font-size="10" font-family="var(--font-mono)">Peso (kg)</text>
          <text x="8" y="${100}" text-anchor="middle" fill="var(--text-muted)" font-size="10" font-family="var(--font-mono)" transform="rotate(-90 8 ${100})">${r}</text>
          ${p.map(([t,e])=>W`
            <circle cx="${b(t)}" cy="${$(e)}" r="4" fill="var(--accent)" opacity="0.7"/>
          `)}
          <line x1="${D}" y1="${O}" x2="${j}" y2="${T}" stroke="var(--danger)" stroke-width="1.5" stroke-dasharray="5 3" opacity="0.6"/>
        </svg>
      </div>
      ...
      <div>
        ...
        <div class="card">
          ...
          <div class="col" style="gap:4px">
            ${Ht.map(t=>{const e=this.hass?.states?.[t.entity],i=e?.state,s=e?.attributes?.unit_of_measurement||"",r=i&&"unknown"!==i&&"unavailable"!==i;return V`
    ...
    `}_handleFileSelect(t){const e=t.target,i=e.files?.[0];i&&(this._selectedFile=i,this._importFileName=i.name,this._importStatus="idle",this._importMessage="")}async _handleImport(){if(this._selectedFile){this._importStatus="loading",this._importMessage="";try{const t=new FormData;t.append("file",this._selectedFile);const e=this.hass.auth?.data?.access_token,i={};e&&(i.Authorization=`Bearer ${e}`);const s=await fetch("/api/monitor_allenamenti/upload",{method:"POST",headers:i,body:t});if(!(s.headers.get("content-type")||"").toLowerCase().includes("application/json")){if(404===s.status)throw new Error("Endpoint upload non disponibile. Aggiorna l'integrazione Monitor Allenamenti e RIAVVIA Home Assistant.");if(401===s.status||403===s.status)throw new Error("Autenticazione fallita. Ricarica la pagina e riprova.");if(413===s.status)throw new Error("File troppo grande per Home Assistant.");const t=(await s.text()).slice(0,200);throw new Error(`Errore server ${s.status}: ${t||s.statusText}`)}const r=await s.json();if(!s.ok)throw new Error(r.error||`HTTP ${s.status}`);this._importStatus="done";const a=[];r.workouts>0&&a.push(`${r.workouts} allenamenti`),r.activity_summaries>0&&a.push(`${r.activity_summaries} giorni attività`),r.sleep_history>0&&a.push(`${r.sleep_history} notti sonno`),r.resting_hr>0&&a.push(`${r.resting_hr} FC riposo`),r.vo2max>0&&a.push(`${r.vo2max} VO2Max`),r.hrv_daily>0&&a.push(`${r.hrv_daily} HRV`),this._importMessage=a.length>0?`Importati: ${a.join(", ")}.`:"Nessun dato nuovo (tutti duplicati).",this._selectedFile=null,this._importFileName=""}catch(t){this._importStatus="error",this._importMessage=t?.message||"Errore durante l'importazione."}}}};It.styles=xt,t([gt({attribute:!1,hasChanged:()=>!0})],It.prototype,"card",void 0),t([ut()],It.prototype,"_importStatus",void 0),t([ut()],It.prototype,"_importMessage",void 0),t([ut()],It.prototype,"_importFileName",void 0),It=t([pt("monitor-settings")],It);const Rt=[{value:"overview",label:"Panoramica"},{value:"workouts",label:"Allenamenti"},{value:"body",label:"Composizione"},{value:"calendar",label:"Calendario"},{value:"stats",label:"Statistiche"},{value:"settings",label:"Impostazioni"}];let Ut=class extends dt{setConfig(t){this._config=t}_fire(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}render(){return this._config?V`
      <div class="field">
        ...
        <select
          ...
          ${Rt.map(t=>V`<option value=${t.value}>${t.label}</option>`)}
        </select>
      </div>
  ...
  `,t([gt({attribute:!1})],Ut.prototype,"hass",void 0),t([gt({attribute:!1})],Ut.prototype,"_config",void 0),Ut=t([pt("monitor-allenamenti-card-editor")],Ut);const Ft={overview:["Panoramica","monitor / panoramica"],workouts:["Allenamenti","monitor / allenamenti"],body:["Composizione","monitor / composizione"],calendar:["Calendario","monitor / calendario"],stats:["Statistiche","monitor / statistiche"],settings:["Impostazioni","monitor / impostazioni"]};let Lt=class extends dt{constructor(){super(...arguments),this._screen="overview",this._mobile=!1,this._drawerOpen=!1,this._desktopCollapsed=!1,this.monitorState=null,this._screenInitialised=!1,this._stateFetched=!1}setConfig(t){this.config=t||{},t?.default_screen&&!this._screenInitialised&&(this._screen=t.default_screen,this._screenInitialised=!0),void 0!==t?.collapse_sidebar&&(this._desktopCollapsed=!!t.collapse_sidebar),this.isConnected&&this._checkPanelMode()}static getConfigElement(){return document.createElement("monitor-allenamenti-card-editor")}static getStubConfig(){return{type:"custom:monitor-allenamenti-card"}}navigate(t){this._screen=t,this._mobile&&(this._drawerOpen=!1)}_checkPanelMode(){if(!this.isConnected)return;const t=this.config?.panel_mode;let e;if(!0===t)e=!0;else if(!1===t)e=!1;else{const t=this.getBoundingClientRect();e=t.top<30&&t.height>200}this.hasAttribute("panel-mode")!==e&&this.toggleAttribute("panel-mode",e);const i=this.config?.panel_offset;"number"==typeof i&&i>=0?this.style.setProperty("--monitor-panel-offset",`${i}px`):this.style.removeProperty("--monitor-panel-offset")}connectedCallback(){super.connectedCallback(),this._checkPanelMode(),setTimeout(()=>this._checkPanelMode(),50),setTimeout(()=>this._checkPanelMode(),250),this._resizeObserver=new ResizeObserver(t=>{this._checkPanelMode();for(const e of t){const t=this.config?.mobile_threshold??700;this._mobile=t>0&&e.contentRect.width<t}}),this._resizeObserver.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),this._eventUnsub?.(),this._eventUnsub=void 0}firstUpdated(){this._checkPanelMode(),this._fetchState()}async _fetchState(){if(this.hass?.callWS)try{this.monitorState=await this.hass.callWS({type:"monitor_allenamenti/get_state"}),this._stateFetched=!0}catch{this._stateFetched||(this.monitorState=null)}}updated(t){super.updated(t),t.has("hass")&&!this._stateFetched&&this._fetchState(),t.has("hass")&&this.hass&&!this._eventUnsub&&this.hass.connection.subscribeEvents(()=>this._fetchState(),"monitor_allenamenti.workout_logged").then(t=>{this._eventUnsub=t})}render(){const[t,e]=Ft[this._screen]||Ft.overview,i=this._mobile&&this._drawerOpen;let s;s=this._mobile?i?"drawer":"mini":this._desktopCollapsed?"mini":"full";const r=_t(this.hass,"punti")||"0",a=_t(this.hass,"streak")||"0";return V`
      ...
      <aside class="sidebar" data-mode="${t}">
        ...
        <div class="sidebar__brand">
          ...
          ${e?q:V`<div>
                ...
                <div class="sidebar__brand-sub">v${"1.5.1"}</div>
              </div>`}
        </div>
        ${e?q:V`<div class="nav-section">Tracking</div>`}
    ...
    `}_renderScreen(){switch(this._screen){case"overview":default:return V`<monitor-overview .card=${this}></monitor-overview>`;case"workouts":return V`<monitor-workouts .card=${this}></monitor-workouts>`;case"body":return V`<monitor-body .card=${this}></monitor-body>`;case"calendar":return V`<monitor-calendar .card=${this}></monitor-calendar>`;case"stats":return V`<monitor-stats .card=${this}></monitor-stats>`;case"settings":return V`<monitor-settings .card=${this}></monitor-settings>`}}};Lt.styles=[mt,xt],t([gt({attribute:!1})],Lt.prototype,"hass",void 0),t([gt({attribute:!1})],Lt.prototype,"config",void 0),t([ut()],Lt.prototype,"_screen",void 0),t([ut()],Lt.prototype,"_mobile",void 0),t([ut()],Lt.prototype,"_drawerOpen",void 0),t([ut()],Lt.prototype,"_desktopCollapsed",void 0),t([ut()],Lt.prototype,"monitorState",void 0),Lt=t([pt("monitor-allenamenti-card")],Lt),window.customCards=window.customCards||[],window.customCards.push({type:"monitor-allenamenti-card",name:"Monitor Allenamenti",description:"Tracker peso e allenamenti con statistiche",preview:!0});export{Lt as MonitorAllenamentiCard};
